...
export default async function DocumentPage({ params }: Props) {
  ...
  const reviewUrl = createReviewUrl({ ownerId, slug: document.slug, versionId: document.currentVersionId, roundId: review.roundId });
