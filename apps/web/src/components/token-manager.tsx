        ...
        <CardContent className="p-0">
          {tokens.length === 0 ? <Empty className="min-h-64 rounded-none border-0"><EmptyHeader><EmptyMedia variant="icon"><KeyRound /></EmptyMedia><EmptyTitle>No API tokens</EmptyTitle><EmptyDescription>Create one above to connect the CLI.</EmptyDescription></EmptyHeader></Empty> : (
            <Table aria-label="API tokens">
              <TableHeader className="border-border/70 bg-muted/35"><TableHead isRowHeader className="px-5 text-[11px] uppercase tracking-[0.14em] text-muted-foreground">Name</TableHead><TableHead className="hidden text-[11px] uppercase tracking-[0.14em] text-muted-foreground sm:table-cell">Status</TableHead><TableHead className="hidden text-[11px] uppercase tracking-[0.14em] text-muted-foreground md:table-cell">Created</TableHead><TableHead className="px-5 text-right text-[11px] uppercase tracking-[0.14em] text-muted-foreground">Action</TableHead></TableHeader>
