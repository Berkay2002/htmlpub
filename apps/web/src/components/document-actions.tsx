  ...
  return (
    <>
      <Card className="mt-6 rounded-2xl border-border/80 bg-card/95 shadow-sm" id="sharing">
        <CardHeader className="border-b border-border/70 px-5 py-4"><CardTitle className="text-sm">Sharing</CardTitle><CardDescription className="mt-1 text-xs">Sharing is enabled automatically when a document is published. Reader, Markdown, and raw HTML links resolve the latest version until revoked or rotated.</CardDescription></CardHeader>
